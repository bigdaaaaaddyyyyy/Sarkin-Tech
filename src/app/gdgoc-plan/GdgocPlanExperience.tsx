    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f7fbff] text-slate-950">
        ...
        >
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                href="#roadmap"
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-slate-950 px-6 py-3 text-sm font-bold text-white shadow-xl shadow-slate-900/15 transition hover:-translate-y-0.5 hover:bg-slate-800"
              >
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                <div
                  className="mb-8 flex h-14 w-14 items-center justify-center rounded-2xl text-white shadow-lg"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-clash text-2xl font-semibold">
                      Phase {phaseOrder.indexOf(activePhase) + 1}: {activePhase}
                    </h3>
                    <p className="mt-1 text-sm leading-6 text-white/65">
                      {phaseCopy[activePhase as keyof typeof phaseCopy]}
                    </p>
                  </div>
                </div>
              </div>
                ...
                {visibleMonths.map((month) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <ChevronDown
                        className={`h-5 w-5 text-slate-400 transition ${activeMonth === month.id ? "rotate-180" : ""}`}
                      />
                    </div>
                  </button>
                ))}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                  <div>
                    <p className="text-sm font-bold uppercase tracking-[0.25em]" style={{ color: selectedMonth.color }}>
                      {selectedMonth.phase}
                    </p>
                    <h3 className="font-clash text-3xl font-bold text-slate-950">
                      {selectedMonth.label}: {selectedMonth.range}
                    </h3>
                  </div>
      ...
      <section id="partners" className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-slate-600">
            Click a partner to see the exchange: what they bring, and what GDGoC BUK offers back.
          </p>
        </div>
            ...
            {partners.map((partner) => (
              <button
                ...
                className={`rounded-3xl border p-4 text-left transition hover:-translate-y-1 ${
                  activePartner === partner.partner
                    ? "border-slate-950 bg-white shadow-xl"
                    : "border-slate-200 bg-white/65 hover:bg-white"
                }`}
              >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="mb-8 flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-black uppercase tracking-[0.3em]" style={{ color: selectedPartner.color }}>
      ...
      <section className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-slate-600">
            Each metric has a minimum target and a stretch target. Tap a card to spotlight the ambition.
          </p>
        </div>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <button
                ...
                className={`rounded-[2rem] border p-5 text-left transition hover:-translate-y-1 ${
                  active
                    ...
                    : "border-slate-200 bg-white/75 text-slate-950 hover:bg-white"
                }`}
              >
                ...
                <div className={`mt-5 h-2 overflow-hidden rounded-full ${active ? "bg-white/10" : "bg-slate-100"}`}>
                  <motion.div
                    className="h-full rounded-full bg-gradient-to-r from-[#1A73E8] to-[#34A853]"
        ...
        <div className="overflow-hidden rounded-[2.5rem] bg-slate-950 text-white shadow-[0_30px_100px_rgba(15,23,42,0.22)]">
          <div className="grid gap-0 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="relative p-8 sm:p-10">
              ...
              <h2 className="mt-4 font-clash text-4xl font-bold sm:text-5xl">
                Build now. Leave infrastructure behind.
              </h2>
              <p className="mt-5 leading-8 text-white/65">
            ...
            <div className="bg-white p-8 text-slate-950 sm:p-10">
              ...
              <div className="mt-8 flex items-center gap-4 rounded-3xl bg-slate-100 p-5">
                <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-full ring-4 ring-white">
                  <Image
